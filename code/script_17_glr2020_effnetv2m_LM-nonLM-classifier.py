...
LOG_DIR = './logs/'
DEVICE = 'cuda:0'
MODEL_NAME = 'effnetv2s_in21k_fulldata'
...
def get_df():
    ...
    df = pd.read_csv(os.path.join(DATA_DIR, 'train_full_fold.csv'))
...
df_valid = df[df['fold'] == 0].reset_index(drop=True).query("index % 10==0")
